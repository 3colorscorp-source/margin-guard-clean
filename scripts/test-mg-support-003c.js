...
async function main() {
  ...
  assert("210. SUPPORT_CHAT_ASSET_VERSION is 003d-c2-1", /SUPPORT_CHAT_ASSET_VERSION = '003d-c2-1'/.test(navSrc));
  ...
  assert("003C.1-42. cache-bust token present", /SUPPORT_CHAT_ASSET_VERSION = '003d-c2-1'/.test(navSrc));
