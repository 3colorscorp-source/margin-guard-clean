...
(function () {
  ...
  async function runPublicQuoteSendPipeline({ payload, message, sendData }) {
    ...
    const zapierPayload = {
      ...
      scope_of_work: payload.scopeSummary || scope,
      depositRequired,
