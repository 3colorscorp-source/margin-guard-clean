/**
 * CH-011C — Update draft Envelope signer (Owner/Admin).
 * POST /.netlify/functions/contract-signer-update
 */
...
exports.handler = async (event) => {
  try {
    ...
    const result = await updateSigner({
      tenantId: tenant.id,
      signerId,
    ...
    console.error("contract-signer-update", err);
    return json(500, {
      ok: false,
      error: "Server error",
      code: "server_error",
