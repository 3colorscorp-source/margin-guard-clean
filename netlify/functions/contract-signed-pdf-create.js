/**
 * CH-011I — Create signed contract PDF (Owner/Admin).
 * POST /.netlify/functions/contract-signed-pdf-create
 */
...
exports.handler = async (event) => {
  try {
    ...
    const result = await createSignedContractPdf({
      tenantId: tenant.id,
      envelopeId,
    ...
    console.error("contract-signed-pdf-create", err?.message || err);
    return json(500, {
      ok: false,
      error: "Server error",
      code: "server_error",
...
exports._test = { ALLOWED_BODY_KEYS, API_VERSION, OWNER_ADMIN_ROLES };
